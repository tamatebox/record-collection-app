    ...
    <div className="record-detail-container">
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: '1.8rem', marginTop: 0, marginBottom: '10px' }}>{record.album_name}</h2>
          <h3 style={{ fontSize: '1.4rem', marginTop: 0, marginBottom: '6px', fontWeight: '500' }}>{record.artist}</h3>
          {record.alphabet_artist && (
            <p style={{ fontSize: '0.9rem', marginTop: 0, fontStyle: 'italic', color: '#666' }}>{record.alphabet_artist}</p>
          )}
          <div className="record-rating" style={{ justifyContent: isMobile ? 'center' : 'flex-start' }}>
